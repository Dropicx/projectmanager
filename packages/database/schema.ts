...
export const users = pgTable("users", {
  ...
  role: text("role", { enum: ["admin", "lead_consultant", "consultant", "analyst", "viewer"] }).default("consultant"),
...
export const knowledge_templates = pgTable("knowledge_templates", {
  ...
  category: text("category", {
    enum: ["architecture_review", "security_audit", "performance_assessment",
           "migration_plan", "training_material", "proposal", "report", "checklist"]
  }).notNull(),
...
export const knowledge_tags = pgTable("knowledge_tags", {
  knowledge_id: uuid("knowledge_id").references(() => knowledge_base.id).notNull(),
...
export const engagement_stakeholders = pgTable("engagement_stakeholders", {
  id: uuid("id").primaryKey().defaultRandom(),
  engagement_id: uuid("engagement_id").references(() => engagements.id).notNull(),
  user_id: text("user_id").references(() => users.id).notNull(),
...
export const files = pgTable("files", {
  ...
  file_type: text("file_type", {
    enum: ["document", "presentation", "spreadsheet", "diagram", "image", "code", "archive", "other"]
  }).default("other"),
