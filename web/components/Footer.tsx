      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div className="md:col-span-1">
          ...
          <p className="text-gray-600 text-sm mb-4">
            The AI-powered navigation system for consailors—sailing through projects with the wind
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/api" className="text-gray-600 hover:text-tekhelet-500 transition-colors">
                API
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="/about" className="text-gray-600 hover:text-tekhelet-500 transition-colors">
                About
              </a>
            </li>
            <li>
              <a href="/blog" className="text-gray-600 hover:text-tekhelet-500 transition-colors">
                Blog
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/terms" className="text-gray-600 hover:text-tekhelet-500 transition-colors">
                Terms of Service
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/gdpr" className="text-gray-600 hover:text-tekhelet-500 transition-colors">
                GDPR
              </a>
            </li>
            <li>
