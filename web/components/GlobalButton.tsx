...
const GlobalButton = forwardRef<HTMLButtonElement, GlobalButtonProps>(
  ({ className, variant = "primary", size = "md", children, ...props }, ref) => {
    ...
    const variantClasses = {
      primary:
        "bg-gradient-to-r from-tekhelet-200/80 via-tekhelet-300/90 to-tekhelet-400/80 text-tekhelet-600 shadow-sm hover:shadow-md hover:shadow-tekhelet-200/30 border border-tekhelet-200/40 backdrop-blur-md hover:from-tekhelet-300/90 hover:via-tekhelet-400/90 hover:to-tekhelet-500/90",
      secondary:
        "bg-gradient-to-r from-teal-200/80 via-teal-300/90 to-teal-400/80 text-teal-600 shadow-sm hover:shadow-md hover:shadow-teal-200/30 border border-teal-200/40 backdrop-blur-md hover:from-teal-300/90 hover:via-teal-400/90 hover:to-teal-500/90",
    };
